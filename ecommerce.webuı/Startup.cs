...
namespace ecommerce.webui
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationContext>(options => options.UseSqlServer("Server=(localdb)\\MsSqlLocalDb;database=ecommerceDb;trusted_connection=true;"));
            services.AddDbContext<ecommerceContext>(options => options.UseSqlServer("Server=(localdb)\\MsSqlLocalDb;database=ecommerceDb;trusted_connection=true;"));
